    ...
    >
        <div class="mr-auto place-self-center lg:col-span-8">
            ...
            <p class="mb-6 opacity-70 lg:mb-8 md:text-lg lg:text-xl">
                Market Master seamlessly integrates robust economic theory into
                a captivating gaming experience that stimulates critical
                thinking and hones investing acumen.
            </p>
